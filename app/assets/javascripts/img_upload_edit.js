$(document).on('turbolinks:load', function(){
  ...
  // -------------画像の追加・削除-------------
  // 画像を追加
  $("#edit_product_img .dropzone-container, #edit_product_img .dropzone-container2").on('change', 'input[type= "file"].upload-image', function(event) {
  ...
  // 画像を削除
  $("#edit_product_img .dropzone-container, #edit_product_img .dropzone-container2").on('click', '.btn_delete', function() {
    // 削除ボタンを押した画像を取得
  ...
  $('#edit_product_wrap').on('submit', function(e){
    e.preventDefault();
